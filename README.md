...
<span>Проекты:</span>
Фриланс: Выполнял заказы на верстку и разработку лэндингов, а также сложные веб-приложения на React.
NeuronPlatform: Разрабатываю frontend для приложения в Telegram, связанного с криптовалютами и NFT на блокчейне TON.
